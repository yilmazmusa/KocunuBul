...
<h3>Özel Gün İndirimli Dersler</h3></div>
<div class="box-content">
<div class="product-layout">
<div class="bestseller-slider">
<?php $bilgi = uruncek(); foreach ($bilgi as $bilgi) {
if ($bilgi['katID']==13 AND $bilgi['durum']=='1'){
?>
<div>
<div class="product-thumb transition equal-height-767">
<div class="sale">İncele</div>
<div class="image">
<a href="<?php echo base_url('ozelgunurunleridetay/'); echo $bilgi['sef']; ?>"><img src="<?php echo base_url();echo $bilgi['mini1']; ?>" alt="" title="" class="img-responsive"/></a>
</div>
<div class="caption">
<div class="price">

...
<div class="col-sm-12"><div class="table-responsive">
  ...
  <form action="<?php echo base_url('anasayfa/iptalformu'); ?>" method="post" class="form-horizontal">
  <fieldset>
    ...
    <div class="form-group required">
      ...
      <div class="col-sm-10">
        <input type="text" name="adres" required value="" placeholder="Adres" class="form-control">
      </div>
    </div>
    <div class="form-group required">
    ...
    <div class="form-group required">
      <label class="col-sm-2 control-label">İptal Nedeni</label>
      <div class="col-sm-10">
        <textarea type="text" name="iptal" required placeholder="İptal Nedeniniz" class="form-control"></textarea>

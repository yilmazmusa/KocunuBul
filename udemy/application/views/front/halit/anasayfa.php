...
<title>asdf | <?php echo $bilgi['title']; ?></title>
<meta property="og:url"           content="<?php echo base_url('egitimdetay/'); echo $bilgi['sef']; ?>" />
...
<?php $this->load->view('front/halitdetay/breadcrumb'); ?>
<?php $this->load->view('front/halitdetay/main_content'); ?>
</div>
</div>
</div>
</div>

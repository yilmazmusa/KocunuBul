...
<div class="container">
  <div class="row">
      ...
      <div class="col-md-3 text-center"><br>
          ...
          <h2><?php echo  $bilgi['adsoyad'] ?></h2>

      </div>

      <div class="col-md-4 text-right"><br>
          <h3>Koç İlgi Alanları</h3>
          <h2 class="text-muted">Spor, Keman</h2>
      </div>

      <div class="col-md-8 text-center"><br>
          <h3 class="text-danger">Koçun Özellikleri</h3>
          <p  style="font-size: 15px;  color:#98c1e0"><i class="fa fa-user"></i>Uzmanımız Mehmet Halid Balçıklı, geleceğe yönelik projelerde <br> daha başarılı

              olmanız için size en uygun kursları vermek için emrinize amaedir.

...
<title>KoçunuBUL | <?php echo $bilgi['adsoyad']; ?></title>
<meta property="og:url"           content="<?php echo base_url('halitdetay/'); echo $bilgi['sef']; ?>" />
...
<?php $this->load->view('front/halit/detay/breadcrumb'); ?>
<?php $this->load->view('front/halit/detay/main_content'); ?>
</div>
</div>
</div>
</div>

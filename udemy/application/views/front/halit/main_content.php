...
<div id="review">
<?php $yorum = yorumlar(); foreach ($yorum as $yorum) { if($yorum['url']=="http://localhost/kocunubul/udemy/egitimdetay/"){ ?>
...
<input type="hidden" name="url" value="<?php echo base_url('egitimdetay/'); ?>">

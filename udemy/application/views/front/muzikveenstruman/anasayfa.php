...
<title>KoçunuBUL | Müzik ve Enstruman </title>
<meta name="description" content="Müzik ve Enstruman" />
...
<?php $this->load->view('front/muzikveenstruman/breadcrumb'); ?>
<?php $this->load->view('front/muzikveenstruman/main_content.php'); ?>
</div>
</div>
</div>
</div>

...
<meta property="og:url"           content="<?php echo base_url('muzikveenstrumandetay/'); echo $bilgi['sef']; ?>" />
...
<?php $this->load->view('front/muzikveenstruman/detay/breadcrumb'); ?>
<?php $this->load->view('front/muzikveenstruman/detay/main_content'); ?>
</div>
</div>
</div>
</div>

...
<meta property="og:url"           content="<?php echo base_url('sinandetay/'); echo $bilgi['sef']; ?>" />
...
<?php $this->load->view('front/sinan/detay/breadcrumb'); ?>
<?php $this->load->view('front/sinan/detay/main_content'); ?>
</div>
</div>
</div>
</div>

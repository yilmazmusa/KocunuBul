...
<meta property="og:url"           content="<?php echo base_url('ascilikdetay/'); echo $bilgi['sef']; ?>" />
...
<?php $this->load->view('front/ascilik/detay/breadcrumb'); ?>
<?php $this->load->view('front/ascilik/detay/main_content'); ?>
</div>
</div>
</div>
</div>

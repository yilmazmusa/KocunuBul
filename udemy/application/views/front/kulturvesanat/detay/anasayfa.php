...
<meta property="og:url"           content="<?php echo base_url('kulturvesanatdetay/'); echo $bilgi['sef']; ?>" />
...
<link href="<?php echo base_url(); ?>assets/front/image/coach.ico" rel="icon" />
...
<?php $this->load->view('front/kulturvesanat/detay/breadcrumb'); ?>
<?php $this->load->view('front/kulturvesanat/detay/main_content'); ?>
</div>
</div>
</div>
</div>

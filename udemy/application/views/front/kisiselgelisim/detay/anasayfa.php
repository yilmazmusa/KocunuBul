...
<meta property="og:url"           content="<?php echo base_url('kisiselgelisimdetay/'); echo $bilgi['sef']; ?>" />
...
<?php $this->load->view('front/kisiselgelisim/detay/breadcrumb'); ?>
<?php $this->load->view('front/kisiselgelisim/detay/main_content'); ?>
</div>
</div>
</div>
</div>

...
<meta property="og:url"           content="<?php echo base_url('programlamayazilimdetay/'); echo $bilgi['sef']; ?>" />
...
<?php $this->load->view('front/programlamayazilim/detay/breadcrumb'); ?>
<?php $this->load->view('front/programlamayazilim/detay/main_content'); ?>
</div>
</div>
</div>
</div>

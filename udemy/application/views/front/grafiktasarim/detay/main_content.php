...
<div id="tab-review" class="product-reviews product-section">
  <div id="review">
  <?php $yorum = yorumlar(); foreach ($yorum as $yorum) { if($yorum['url']=="http://localhost/kocunubul/udemy/grafiktasarimdetay/"){ ?>
  ...
  </div><form action="<?php echo base_url('anasayfa/yorumlar'); ?>" method="POST" class="form-horizontal">
<div id="review"></div>
...
<input type="hidden" name="url" value="<?php echo base_url('grafiktasarimdetay/'); ?>">

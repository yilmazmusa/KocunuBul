...
<meta property="og:url"           content="<?php echo base_url('grafiktasarimdetay/'); echo $bilgi['sef']; ?>" />
...
<?php $this->load->view('front/grafiktasarim/detay/breadcrumb'); ?>
<?php $this->load->view('front/grafiktasarim/detay/main_content'); ?>
</div>
</div>
</div>
</div>

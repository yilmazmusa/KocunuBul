...
<meta property="og:url"           content="<?php echo base_url('saglikveyasamdetay/'); echo $bilgi['sef']; ?>" />
...
<?php $this->load->view('front/saglikveyasam/detay/breadcrumb'); ?>
<?php $this->load->view('front/saglikveyasam/detay/main_content'); ?>
</div>
</div>
</div>
</div>

...
<meta property="og:url"           content="<?php echo base_url('bilisimveteknolojidetay/'); echo $bilgi['sef']; ?>" />
...
<?php $this->load->view('front/bilisimveteknoloji/detay/breadcrumb'); ?>
<?php $this->load->view('front/bilisimveteknoloji/detay/main_content'); ?>
</div>
</div>
</div>
</div>

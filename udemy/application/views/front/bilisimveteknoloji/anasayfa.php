...
<title>KoçunuBUL | Bilişim ve Teknoloji  </title>
...
<?php $this->load->view('front/bilisimveteknoloji/breadcrumb'); ?>
<?php $this->load->view('front/bilisimveteknoloji/main_content.php'); ?>
</div>
</div>
</div>
</div>

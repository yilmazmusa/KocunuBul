...
<meta property="og:url"           content="<?php echo base_url('hobielsanatlari/'); echo $bilgi['sef']; ?>" />
...
<?php $this->load->view('front/hobielsanatlari/detay/breadcrumb'); ?>
<?php $this->load->view('front/hobielsanatlari/detay/main_content'); ?>
</div>
</div>
</div>
</div>

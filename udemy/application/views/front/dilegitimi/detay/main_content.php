...
<div id="tab-review" class="product-reviews product-section">
  <div id="review">
  <?php $yorum = yorumlar(); foreach ($yorum as $yorum) { if($yorum['url']=="http://localhost/kocunubul/uygulama/dilegitimidetay/"){ ?>
...
<input type="hidden" name="url" value="<?php echo base_url('dilegitimidetay/'); ?>">

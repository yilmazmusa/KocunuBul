...
<meta property="og:url"           content="<?php echo base_url('ozelgunurunleridetay/'); echo $bilgi['sef']; ?>" />
...
<?php $this->load->view('front/ozelgunurunleri/detay/breadcrumb'); ?>
<?php $this->load->view('front/ozelgunurunleri/detay/main_content'); ?>
</div>
</div>
</div>
</div>

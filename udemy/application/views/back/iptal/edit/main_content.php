       ...
       <div class="col-xs-12">
         ...
         <div class="box">
           <div class="box-header">
             <h3 class="box-title">İptal Talep  Formu</h3>
           ...
           <form class="form-horizontal" >
              ...
              <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <label for="inputEmail3" class="col-sm-2 control-label"> İptal Nedeni</label>

                      <div class="col-sm-10">

                            <input type="text" name="iptal" value="<?php echo $bilgi['iptal']; ?>" class="form-control">
              ...
              <div class="box-footer">
                  <a href="<?php echo base_url('yonetim/iptaltalep'); ?>" type="submit" class="btn btn-warning"> Geri Dön</a>

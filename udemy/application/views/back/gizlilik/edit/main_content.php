       ...
       <div class="col-xs-12">
         ...
         <div class="box">
           <div class="box-header">
             <h3 class="box-title">Gizlilik Sözleşmesi Düzenleme Formu</h3>

           </div>

           <form class="form-horizontal" action="<?php echo base_url('yonetim/gizlilikguncelle'); ?>" method="post" enctype="multipart/form-data">
              ...
              <div class="box-footer">
                  <a href="<?php echo base_url('yonetim/gsozlesme'); ?>" type="submit" class="btn btn-warning"> Vazgeç</a>

       ...
       <div class="col-xs-12">
         ...
         <div class="box">
           <div class="box-header">
             <h3 class="box-title">Satış Sözleşmesi Düzenleme Formu</h3>

           </div>

           <form class="form-horizontal" action="<?php echo base_url('yonetim/satisguncelle'); ?>" method="post" enctype="multipart/form-data">
